...
{\small $^\dagger$Liar's Dice ``full removal'' forces challenge-only, which retains strategic value (see \S\ref{sec:boundaries}). 2-dice variant uses DQN (25 actions, $200{,}000{+}$ estimated info sets).}
\end{table}
